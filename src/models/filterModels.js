...
// Adds name property to each filter and writes the filter key there so the key of each filter is available in the model.
export const filterMap = Object.entries(filterMapWithoutName).reduce((acc, [key, value]) => {
